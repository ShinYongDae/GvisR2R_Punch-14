...
void CDlgFrameHigh::DispFdCnt()
{
	...
	CString str;
	int nFeedCntEng = (int)pDoc->m_pMpeData[1][4];	// 각인부 Feeding 횟수
	int nFeedCntAoi = (int)pDoc->m_pMpeData[1][5];	// 검사부 Feeding 횟수
	int nFeedCntMk = (int)pDoc->m_pMpeData[1][6];	// 마킹부 Feeding 횟수
