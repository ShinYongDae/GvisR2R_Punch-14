	...
	if (nCmdCode == _SetSig)
	{
		...
		case _SigInx::_DualTest:
			if (pDoc->WorkingInfo.LastJob.bDualTest != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_DualTest] = TRUE;
		...
		case _SigInx::_SampleTest:
			if (pDoc->WorkingInfo.LastJob.bSampleTest != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_SampleTest] = TRUE;
//#ifdef USE_MPE
...
//#endif
		...
		case _SigInx::_TestMode:
			if(pDoc->GetTestMode() != (int)SockData.nData1) // MODE_NONE = 0, MODE_INNER = 1, MODE_OUTER = 2
			{
				...
				//	pDoc->WorkingInfo.CurrModel.nTestMode = (int)SockData.nData1; // MODE_NONE = 0, MODE_INNER = 1, MODE_OUTER = 2
				//else
				//	pDoc->WorkingInfo.NextModel.nTestMode = (int)SockData.nData1; // MODE_NONE = 0, MODE_INNER = 1, MODE_OUTER = 2
...
//#endif
		...
		case _SigInx::_RecoilerCcw:
			if(pDoc->WorkingInfo.LastJob.bOneMetal != (SockData.nData1 > 0) ? TRUE : FALSE)	// OneMetal : TRUE -> SetTwoMetal(FALSE);
			{
				...
				pView->m_bRcvSig[_SigInx::_RecoilerCcw] = TRUE;
//#ifdef USE_MPE
...
//				::WritePrivateProfileString(_T("Last Job"), _T("One Metal On"), (SockData.nData1 > 0) ? _T("1") : _T("0"), PATH_WORKING_INFO);// IDC_CHK_ONE_METAL - Recoiler\r정방향 CW : FALSE
		...
		case _SigInx::_UncoilerCcw:
			if(pDoc->WorkingInfo.LastJob.bTwoMetal != (SockData.nData1 > 0) ? TRUE : FALSE)	// TwoMetal : TRUE -> SetTwoMetal(TRUE);
			{
				...
				pView->m_bRcvSig[_SigInx::_UncoilerCcw] = TRUE;
//#ifdef USE_MPE
...
//				::WritePrivateProfileString(_T("Last Job"), _T("Two Metal On"), (SockData.nData1 > 0) ? _T("1") : _T("0"), PATH_WORKING_INFO);// IDC_CHK_TWO_METAL - Uncoiler\r역방향 ON : TRUE	
		...
		case _SigInx::_DoorRecoiler:
			if (pDoc->WorkingInfo.LastJob.bRclDrSen != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_DoorRecoiler] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
//#endif
		...
		case _SigInx::_DoorAoiUp:
			if (pDoc->WorkingInfo.LastJob.bAoiUpDrSen != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_DoorAoiUp] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
//#endif
		...
		case _SigInx::_DoorAoiDn:
			if (pDoc->WorkingInfo.LastJob.bAoiDnDrSen != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_DoorAoiDn] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
//#endif
		...
		case _SigInx::_DoorMk:
			if (pDoc->WorkingInfo.LastJob.bMkDrSen != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_DoorMk] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
//#endif
		...
		case _SigInx::_DoorEngrave:
			if (pDoc->WorkingInfo.LastJob.bEngvDrSen != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_DoorEngrave] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
//#endif
		...
		case _SigInx::_DoorUncoiler:
			if (pDoc->WorkingInfo.LastJob.bUclDrSen != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_DoorUncoiler] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
//#endif
		...
		case _SigInx::_CleannerAoiUp:
			if (pDoc->WorkingInfo.LastJob.bUseAoiUpCleanRoler != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_CleannerAoiUp] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
//#endif
		...
		case _SigInx::_CleannerAoiDn:
			if (pDoc->WorkingInfo.LastJob.bUseAoiDnCleanRoler != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_CleannerAoiDn] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
//#endif
		...
		case _SigInx::_UltraSonicAoiDn:
			if(pDoc->WorkingInfo.LastJob.bUseAoiDnUltrasonic != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_UltraSonicAoiDn] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
//#endif
		...
		case _SigInx::_UltraSonicEngrave:
			if (pDoc->WorkingInfo.LastJob.bUseEngraveUltrasonic != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_UltraSonicEngrave] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
//#endif
		...
		case _SigInx::_Use380mm:
			if (pDoc->WorkingInfo.LastJob.bUse380mm != (SockData.nData1 > 0) ? TRUE : FALSE)
			{
				...
				pView->m_bRcvSig[_SigInx::_Use380mm] = TRUE;
//#ifdef USE_MPE
//				if (pView && pView->m_pMpe)
...
void CEngrave::SetTestMode(int nMode)
{
	if (!pDoc)
		return;
	...
	SocketData.nData1 = nMode; // MODE_NONE = 0, MODE_INNER = 1, MODE_OUTER = 2
...
// SetInfo()
void CEngrave::SetModelUpName(CString sModel)
{
	if (!pDoc) return;		
	...
	StringToChar(sModel, cData);
	sprintf(SocketData.strData, "%s", cData);
	SendCommand(SocketData);
}

void CEngrave::SetLotUpName(CString sLot)
{
	if (!pDoc) return;
	...
	StringToChar(pDoc->WorkingInfo.CurrModel.sLot, cData);
	sprintf(SocketData.strData, "%s", cData);
	SendCommand(SocketData);
}

void CEngrave::SetLayerUpName(CString sLayer)
{
	if (!pDoc) return;
	...
	StringToChar(sLayer, cData);
	sprintf(SocketData.strData, "%s", cData);
	SendCommand(SocketData);
}

void CEngrave::SetLayerDnName(CString sLayer)
{
	if (!pDoc) return;
